...
import videoThumb from '../../assests/images/videobanner.png';

const Video = () => {
    return (
        <div className={styles.videoWrapper}>
            <div className={styles.videoContainer}>
                <img src={videoThumb} alt="Video lập trình" className={styles.thumbnail} />
